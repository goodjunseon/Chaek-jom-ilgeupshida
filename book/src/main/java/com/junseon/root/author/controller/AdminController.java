package com.junseon.root.author.controller;

import com.junseon.root.author.service.AuthorService;
import com.junseon.root.book.model.dto.BookCreateDTO;
import com.junseon.root.book.service.BookGenreService;
import com.junseon.root.book.service.BookService;
import com.junseon.root.book.service.GenreService;
import com.junseon.root.user.model.dto.UserEditDTO;
import com.junseon.root.user.model.dto.UserFindAllDTO;
...
public class AdminController {
    ...
    public String userEditForm(@PathVariable("userId") Long userId, HttpSession session, Model model) {
        ...
        UserEditDTO user = userService.findUserEditDTOById(userId);
    ...
    public String userEditByAdmin(@PathVariable("userId") Long userId, @ModelAttribute UserEditDTO userEditDTO, HttpSession session, Model model) {
        ...
        // 사용자 수정
        userService.UserUpdateByAdmin(userId, userEditDTO);
